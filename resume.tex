...
\name{Matthew Guindin}
\address{matt@guindin.com \\ \underline{\href{https://github.com/mguindin}{Github: mguindin}}}
...
\begin{rSection}{Volunteer Roles}
    \begin{description}
    \item[FIRST Robotics NYC Regional] Fall, 2009 - Spring, 2011
    \item[FIRST Robotics Team 358, Carle Place High School] \textit{Mentor} - Fall, 2009 - Spring, 2011
    \item[FIRST Robotics Team 2068, Osbourn Park High School] \textit{Mentor} - Fall, 2008 - Spring, 2009
    \end{description}
\end{rSection}
